    ...
    private void regenerateAsync(RegeneratorBlock rb) {
        ...
        plugin.getServer().getScheduler().runTaskAsynchronously(plugin, () -> {
            try (EditSession editSession = WorldEdit.getInstance()
                ...
                // ── Paso 1: escaneo en la misma sesión ───────────────
                // Usamos una sola sesión para leer y escribir — FAWE
                // cachea el estado correctamente dentro de la misma sesión.
                // Recolectamos primero para saber si hay algo que hacer.
                ...
                // Sin cultivos inmaduros — salir sin escribir nada
                if (toGrow.isEmpty()) return;

                // ── Paso 2: escritura en la misma sesión ─────────────
                int grown = 0;
